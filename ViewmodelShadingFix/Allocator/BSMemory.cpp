...
#else
	if (*(UInt8*)0x401190 != 0x51) {
		// Is GECK
		pMemoryManager	= (void*)0x10E5FC0;
		Allocate		= (void* (__thiscall*)(void*, size_t))0xA558F0;
		ReAllocate		= (void* (__thiscall*)(void*, void*, size_t))0xA55B00;
		Deallocate		= (void(__thiscall*)(void*, void*))0xA55A40;
		Size			= (size_t(__thiscall*)(void*, void*))0xA55880;
		CreateHeap		= (int(__cdecl*)(UInt32))0xBD40EA;

		CreateHeapIfNotExisting(0x10F2DCC, 0xBC2067);
	}
	else {
		pMemoryManager	= (void*)0x1090A78;
		Allocate		= (void* (__thiscall*)(void*, size_t))0x86B930;
		ReAllocate		= (void* (__thiscall*)(void*, void*, size_t))0x86BAE0;
		Deallocate		= (void(__thiscall*)(void*, void*))0x86BA60;
		Size			= (size_t(__thiscall*)(void*, void*))0x86B8C0;
		CreateHeap		= (int(__cdecl*)(UInt32))0xC160AB;

		CreateHeapIfNotExisting(0x117A32C, 0xC05EC0);
	}
#endif
}
